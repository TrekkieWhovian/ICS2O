...
print("Any spaces in the software you are trying to guess will have to be indicated with a dash (-).")
...
wordBank = []
blank2 = ("_"*lenWord)
while(guess < 6): #Allows the user to keep on entering a guess until there are 6
    ...
    while(check < lenWord and lenUser == 1): #Checks to see if the user's guess is one of the characters in the word
        ...
        if(userLetter == (word[check]) and lenUser == 1): #If the user's letter is one of the characters in the word, it will add it to the blank word-box
            blank = str(blank[0:check]+userLetter+blank[check:lenWord])
            blank2 = str(blank2[0:check]+userLetter+blank2[check:lenWord])
        check = (check + 1)
    ...
    if(userLetter == "hint" and word == 0): #Gives the hint for "microsoft-word"
        print("It was originally released by Microsoft in 1983 for Xenix systems.")
    if(userLetter == "hint" and word == 1): #Gives the hint for "minecraft"
        print("This popular video game was released on May 17, 2009.")
    if(userLetter == "hint" and word == 2): #Gives the hint for "steam"
        print("There are nearly 90 million active users on this platform.")
    if(userLetter == "hint" and word == 3): #Gives the hint for "spotify"
        print("This software was created by Daniel Ek and Martin Lorentzon.")
    if(userLetter == "hint" and word == 4): #Gives the hint for "google-drive"
        print("The desktop app shut-down on December 11, 2017.")
    if(userLetter == "hint" and word == 5): #Gives the hint for "gimp"
        print("The code was written in C.")
    if(userLetter == "hint" and word == 6): #Gives the hint for "powerpoint"
        print("This software was initially exclusive to Macintosh computers.")
    if(userLetter == "hint" and word == 7): #Gives the hint for "photoshop"
        print("This software was developed by Adobe.")
    if(userLetter == "hint" and word == 8): #Gives the hint for "discord"
        print("The target audience is gamers.")
    if(userLetter == "hint" and word == 9): #Gives the hint for "instagram"
